$(document).ready(function () {
    ...
    $(".close-popup").on("click", function () {
        ...
        $("body").addClass("hidden_commercial_summary_popup");
        $("body").addClass("hidden_commercial_programme_popup");
        $("body").addClass("hidden-popup");
        $("body").addClass("hidden_commercial_contractor_popup");
        $("body").addClass("hidden_commercial_variations_popup");
    });
    ...
    $(".add_contractor_btn").on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_commercial_summary_popup");
    });
    $(".create_commercial_programme_popup").on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_commercial_programme_popup");
    });
    $(".create_commercial_contractor_popup").on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_commercial_contractor_popup");
    });
    $(".create_commercial_variations_popup").on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_commercial_variations_popup");
    });
});