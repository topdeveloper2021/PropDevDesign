$(document).ready(function () {
    ...
    $(".close-popup").on("click", function () {
        ...
        $("body").addClass("hidden_directory_popup");
        $("body").addClass("hidden_viewing_popup");
        $("body").addClass("hide_section");
    });
    $("#projectFiles").find('tr >td:not(:first-child)').on("click", function () {
    ...
    $(".add_directory").on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_directory_popup");
    });
    $("#projectDirectory").find('tr >td:not(:first-child)').on("click", function () {
        $("body").removeClass("hide_section");
        $("body").removeClass("hidden_viewing_popup");
    });
